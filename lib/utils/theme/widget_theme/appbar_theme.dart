...
class TAppBarTheme {
  ...
  static const lightAppBarTheme = AppBarTheme(
    ...
    titleTextStyle: TextStyle(fontSize: 18, fontWeight: FontWeight.w600,color: TColors.black,fontFamily: 'Urbanist'),
  );
  static const darkAppBarTheme = AppBarTheme(
    ...
    titleTextStyle: TextStyle(fontSize: 18, fontWeight: FontWeight.w600,color: TColors.white,fontFamily: 'Urbanist'),
  );
